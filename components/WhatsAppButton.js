  ...
  return (
    <div className={`fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-40 flex-col items-end gap-2 ${isProductPage ? 'hidden sm:flex' : 'flex'}`}>
      ...
      <a
        ...
        className="flex h-8 w-8 sm:h-11 sm:w-11 items-center justify-center rounded-full bg-[#25D366] shadow-md shadow-green-400/20 hover:bg-[#20bf5b] hover:scale-110 hover:opacity-100 transition-all duration-200 opacity-60"
        aria-label="Chat on WhatsApp"
      >
        <svg viewBox="0 0 32 32" className="h-4 w-4 sm:h-6 sm:w-6 fill-white">
