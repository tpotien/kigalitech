...
export const SMS_TEMPLATES = {
  orderConfirmed: (name, orderId, total) =>
    `Dear ${name}, your KigaliTech order #${orderId} is confirmed! Total: ${total}. Track: kigalitechservices.com/orders/${orderId}`,

  orderShipped: (name, orderId) =>
    `Hi ${name}! Your order #${orderId} has been shipped. Track: kigalitechservices.com/orders/${orderId}`,
