    ...
    if (action === 'offer') {
      ...
      await prisma.notification.create({
        data: {
          ...
          body: `We're offering RWF ${Math.round(amt).toLocaleString()} for your ${tradeIn.productName}. Open your account to accept, counter, or decline.`,
    ...
    if (action === 'accept_counter') {
      ...
      await prisma.notification.create({
        data: {
          ...
          body: `We accepted your counter-offer of RWF ${Math.round(tradeIn.counterPrice).toLocaleString()} for your ${tradeIn.productName}. Awaiting final confirmation.`,
          link: '/account?tab=trade-ins',
        },
      });
      return res.json(updated);
    ...
    if (action === 'counter_offer') {
      ...
      await prisma.notification.create({
        data: {
          ...
          body: `We've revised our offer to RWF ${Math.round(amt).toLocaleString()} for your ${tradeIn.productName}. Open your account to respond.`,
          link: '/account?tab=trade-ins',
        },
      });
      sendTradeInUpdate({ email: tradeIn.user?.email, name: tradeIn.user?.name, productName: tradeIn.productName, action: 'offer', offeredPrice: amt }).catch(() => {});
