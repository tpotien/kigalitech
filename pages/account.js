                      ...
                      {ti.status === 'offer_made' && !msg?.startsWith('✓') && (
                        <div className="border-t border-sky-100 dark:border-sky-800 bg-sky-50/30 dark:bg-sky-900/10 px-5 pb-5">
                          <div className="pt-4 mb-3">
                            <p className="font-semibold text-slate-800 dark:text-slate-200">We're offering <span className="text-sky-700 dark:text-sky-400">${(ti.offeredPrice / 100).toFixed(2)}</span> for your {ti.productName}</p>
                      ...
                      <div className="p-5">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <p className="font-bold text-slate-900 dark:text-slate-100">${(order.total / 100).toFixed(2)}</p>
                          </div>
                        </div>
                          ...
                          <div className={`mx-5 mt-4 rounded-2xl p-4 ${
                            ...
                            <div className="flex items-center justify-between gap-3 flex-wrap">
                              <div>
                                ...
                                <p className="text-3xl font-extrabold text-slate-900 dark:text-slate-100 mt-0.5">${(ticket.quotedCost / 100).toFixed(2)}</p>
