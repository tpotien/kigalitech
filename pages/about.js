    ...
    <Layout>
      <div className="bg-white dark:bg-slate-950">
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={stat.label} className="rounded-2xl bg-red-50 dark:bg-sky-900/30 border border-sky-100 dark:border-sky-800 p-6 text-center">
          ...
          {/* Values */}
          <div>
            <p className="text-sm font-semibold uppercase tracking-widest text-primary text-center">Why Choose Us</p>
          ...
          <div className="rounded-3xl bg-slate-900 px-8 py-12 text-center">
            ...
            <Link href="/products" className="mt-6 inline-block rounded-full bg-primary px-8 py-3 font-semibold text-white no-underline hover:bg-primary">
              Shop Now
            </Link>
          </div>
        </div>
